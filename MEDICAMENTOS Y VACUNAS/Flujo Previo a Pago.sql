CREATE procedure Reporte_Flujo2Bien
	@LoteFlujo varchar(10),
	@SemanaPagoTeso varchar(4)
as
--------------------------------------------
...
insert into nuReportCuentas
	(LoteFacturaDyA,Referencia,OrdenCompra,FechaFactura,fechaRecepcion,fechaRecepTesoreria,NombreProveedor,ClaveProveedor,FacturaProveedor,Importe,Requisicion,Semana,Tipo,CuryPmtAmt,CuryDiscAmt,Cuenta, CtaDecripcion, LoteFlujo)
SELECT Lote_PASIVO, Referencia_PASIVO, ORDEN, getdate(), getdate(), getdate(), NombreProveedor, CLAVEPROV, NoFactProv, importe_Pasivo, 'Previo', Semana, MotivoRet, APCheckDet.CuryPmtAmt, 0, CuentaPago, NombreCta, @LoteFlujo
...
UPDATE R SET R.CuryDiscAmt=( case when V.s4future03<>0 then 
                              ...
                              from nuReportCuentas R 
							  inner join vendor  V on R.ClaveProveedor=V.vendid
